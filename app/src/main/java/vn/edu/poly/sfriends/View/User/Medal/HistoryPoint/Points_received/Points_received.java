package vn.edu.poly.sfriends.View.User.Medal.HistoryPoint.Points_received;
...
public class Points_received extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_point_recived, container, false);
        initControl();
        initData();
        return view;
    }
    ...
    private void initControl() {
        listView = view.findViewById(R.id.listview_point_recived);
