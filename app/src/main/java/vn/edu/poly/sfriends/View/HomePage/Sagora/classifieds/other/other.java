package vn.edu.poly.sfriends.View.HomePage.Sagora.classifieds.other;
...
public class other extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_other_classified, container, false);
        initControl();
        initData();
        initEvent();
        initOnClick();
    ...
    private void initControl() {
        listView = view.findViewById(R.id.listview_other);
    }
