package vn.edu.poly.sfriends.View.HomePage.Sagora.classifieds.wanted;
...
public class wanted extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_wanted_classifi, container, false);
        initControl();
        initData();
        initEvent();
        initOnClick();
    ...
    private void initControl() {
        listView = view.findViewById(R.id.listview_wanted);
    }
